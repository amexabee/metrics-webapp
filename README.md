...
- [Live Demo Link](https://amanuel-movies.netlify.app/)
...
```sh
  cd my-folder
  git clone https://github.com/amexabee/metrics-webapp.git
```
...
I would like to thank Nelson Sakwa and Behance for allowing to use the Original design.
